	...
	[
		{
			...
			engDescription: "co-founder and president of Mykola Pirogov First Volunteer Mobile Hospital",
			engText: `At the beginning of the war, we faced up with a problem when more than a half of the donations from abroad, directed to Mykola Pyrohov First Volunteer Mobile Hospital, couldn't be transferred to Ukraine. Banks of the USA, Canada, UK and the EU blocked these transactions as suspicious. We need that donations "here and now", but it took several weeks to receive them. Therefore, it is extremely important for Ukrainians to have their own financial payments institution in Europe. And it should be an EU bank and a Ukrainian bank at the same time - with all the guarantees and reputation of a European bank and the technology of a Ukrainian bank. Mykola Pyrohov First Volunteer Mobile Hospital  is looking forward to becoming one of the first clients of the Global Ukraine fintech services ».`
		},
		{
			id: '01',
			imgMin: "feedback1.png",
