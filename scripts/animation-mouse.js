...
(function () {
	// Init
	var container = document.querySelector(".animation-action__mockup-container"),
		inner = document.querySelector(".act-mockup-first"),
		inner2 = document.querySelector(".act-mockup-second");
